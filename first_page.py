...
class FirstWin1():
    def __init__(self):
      ...
      # self.root.state('zoomed')
        ...
        self.headLbl = Label(self.frame1, text = 'CardioCare', bg = '#ddeaf0', fg = 'black', font = ('BankGothic Md BT', 40, 'bold'))
        #self.headLbl.pack()
        self.headLbl.place(x = 150, y = 90)
        # text
