...
class FirstWin2():
    def __init__(self):
      ...
      # self.root.state('zoomed')
        self.root.title('2Registration window')
        self.root.geometry('1366x768')
        self.img = PIL.Image.open(os.path.abspath("images\ml.jpg"))
